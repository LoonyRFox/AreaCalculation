...
///  но идея не рабочая так как для площади квадрата нам нужна или длина диагонали, или длина стороны (результат одинаковый, но алгоритмы разные), то есть 1 параметр, как и у круга.
